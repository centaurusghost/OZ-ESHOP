                ...
                <div class="row gx-4 gx-lg-4 row-cols-sm-1 row-cols-md-2 row-cols-xl-3 ">
                    ...
                    <div class="col mb-5">
                        <div class="card d-flex justify-content-center align-items-center " style="height:200px;">
                            <p style="color:#3a4468;" class="fw-bold fs-5">Total Users: <span>100</span></p>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card d-flex justify-content-center align-items-center " style="height:200px;">
                            <p style="color:#3a4468;" class="fw-bold fs-5">Total Products: <span>100</span></p>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card d-flex justify-content-center align-items-center " style="height:200px;">
                            <p style="color:#3a4468;" class="fw-bold fs-5">Total Category: <span>100</span></p>
                        </div>
                    </div>

                    <div class="col mb-5">
                        <div class="card d-flex justify-content-center align-items-center " style="height:200px;">
                            <p style="color:#3a4468;" class="fw-bold fs-5">Total Transcation: <span>RS. 30K+</span></p>
                        </div>
                    </div>
                </div>
            </div>
