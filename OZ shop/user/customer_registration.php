...
<body>
  ...
  if (isset($_POST['user_registration_botton'])) {
   ...
   // window.open("http://localhost/OZ%20shop/loginhandler/login_test_page.php?", "_self");


    // function refillForm(){
    //   $refill_name=$user_fullname;
    //   $refill_username=$user_username;
    //   $refill_email=$user_email;
    //   $refill_phone_number=$user_phone_number ;
    //   $refill_password=$user_password;
    //   $refill_confirm_password=$user_confirm_password;
    //   $refill_bank_name=$user_bank_name;
    //   $refill_branch_name=$user_bank_branch_name;
    //   $refill_account_number=$user_bank_account_number;
